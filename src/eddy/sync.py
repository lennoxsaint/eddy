...
CANONICAL_SURFACES = (
    ...
    "evals/evals.json",
    "evals/professional-youtube-100-rubric.json",
    "evals/professional-youtube-corrections-v1.json",
    "evals/professional-youtube-corrections-v2.json",
    "evals/professional-youtube-corrections-v3.json",
    "references/commands.md",
    "references/creator-good-v1.json",
    "references/owner-profiles/lennox-professional-youtube-v1.json",
    "references/owner-profiles/lennox-professional-youtube-v2.json",
    "references/owner-profiles/lennox-professional-youtube-v3.json",
    "references/verifier-review-contract.json",
    "references/verifier-review-contract-v2.json",
    "references/professional-gate-evidence-contracts-v2.json",
    "references/project-fact-brief.md",
    "references/correction-promotion.md",
    "references/design-contract-lifecycle.md",
    "references/hyperframes-doctrine-v0.7.3.json",
    "references/hyperframes-v0.7.3/design-adherence.md",
    "references/hyperframes-v0.7.3/design-spec.md",
    "references/hyperframes-v0.7.3/house-style.md",
    "references/hyperframes-v0.7.3/video-composition.md",
