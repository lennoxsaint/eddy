...
def edit(
    ...
    motion_mode: str = typer.Option(
        "required",
        "--motion-mode",
        help="First-60 motion mode for default edits: required or off.",
    ),
    audio_audition: str = typer.Option(
        "required",
        "--audio-audition",
        help="Local Studio Sound audition mode: required or off.",
    ),
