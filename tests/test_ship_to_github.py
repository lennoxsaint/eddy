...
def test_tag_must_match_project_version():
    assert ship.tag_matches_version("v1.10.3", "1.10.3") is True
    assert ship.tag_matches_version("1.10.3", "1.10.3") is False
    assert ship.tag_matches_version("v1.10.2", "1.10.3") is False
